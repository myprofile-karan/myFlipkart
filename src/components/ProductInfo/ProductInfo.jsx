        ...
        data.map((item) => {
          ...
          if (item.title === title) {
            return (
              ...
              >
                <div className="row">
                  <div className="imgSec col-12 col-sm-12 col-md-1 d-flex flex-column gap-3">
                  ...
                  <div className="col-7">
                    ...
                    <div className="d-flex flex-column gap-2">
                      ...
                      <p>
                        ...
                        <span>
                          <strong>Bank Offer</strong> Flat ₹100 Cashback on
                          Paytm Wallet. Min Order Value ₹1,000. Valid once per
                          Paytm accountT&C
                        </span>
                      </p>
                      <p>
                      ...
                      <p>
                        <i className="fa-solid fa-tag text-success me-2 fs-5"></i>
                        <span>
                          <strong>Special Price</strong> Get extra 34% off
                          (price inclusive of cashback/coupon)T&C
                        </span>
                      </p>
                      <p>
                        <i className="fa-solid fa-tag text-success me-2 fs-5"></i>
                        <span>
                          Buy any product & get Rs. 150 Off on your next
                          purchase of GeysersT&C
                        </span>
                      </p>
                    </div>
                  </div>
